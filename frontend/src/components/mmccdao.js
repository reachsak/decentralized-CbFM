...
const NFTComponentdao = (props) => {
  //   const { account } = props;
  const account = "0x3aF5647E366fb51C89e4c43Bc8C173dAa018AFf6";
      ...
      >
        {imageURLs.map((url, index) => (
          <div
            key={index}
            style={{
              width: "90px", // Set the fixed width for each image container
              height: "90px", // Set the fixed height for each image container
...
export default NFTComponentdao;
